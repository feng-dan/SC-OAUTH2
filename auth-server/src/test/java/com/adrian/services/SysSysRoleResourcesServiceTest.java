...
/**
 * @author asus
 * @ClassName SysSysRoleResourcesServiceTest
 * @description TODO
 * @Date 2018/11/7 14:32
 * @Version 1.0v
 **/
public class SysSysRoleResourcesServiceTest extends AuthServerApplicationTests {
    ...
    public void saveFatherTest() {
        com.adrian.dto.RoleResources roleResources = new com.adrian.dto.RoleResources();
        ...
        SysRoleResources save = roleResourcesService.addParentResource(roleResources);
